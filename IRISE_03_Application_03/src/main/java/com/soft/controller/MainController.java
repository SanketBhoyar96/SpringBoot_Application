...
public String logout(HttpSession httpSession,HttpServletRequest httpServletRequest) {
  ...
  @RequestMapping("/all")
public String ExploreCourseAll() {
	 return "ExploreCourses";
}

  @RequestMapping("/viewCourses")
public String viewDetCourses() {
	 return "viewDetailsCourses";
}
  @RequestMapping("/subscribeCourseForm")
  public String subscribeCourseApp() {
  	 return "subscribeCourseForm";
  }
  @RequestMapping("/Makepayment")
  public String Makepayment() {
  	 return "studMakePayment";
  }
